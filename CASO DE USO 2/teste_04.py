#Caso de teste 9:
#Descrição:  Verificar se a pesquisa por mapas funciona corretamente
#Passos:
#   Acessar a URL: https://www.google.com
#   Inserir um termo de busca
#   Aguardar o carregamento da página de resultados
#   Clicar no link do Google Maps
#   Aguardar que o mapa apareça
...
try:
    ...
    # Clicar no link do Google Maps
    mapa_link = driver.find_element(By.LINK_TEXT, "Maps")
    mapa_link.click()
    time.sleep(5)

    # Verificar se o Google Maps foi carregado
    if "https://www.google.com/maps" in driver.current_url:
        print("\nA pesquisa por maps funcionou corretamente e o Google Maps foi carregado.")
    else:
        print("\nA pesquisa por maps NÃO funcionou.")
