#Caso de teste 7:
#Descrição:  Verificar se a pesquisa por notícias funciona corretamente
#Passos:
#   Acessar a URL: https://www.google.com
#   Inserir um termo de busca
#   Aguardar o carregamento da página de resultados
#   Clicar na aba "Notícias"
#   Verificar se as notícias foram carregadas
...
try:
    ...
    # Clicar no link de notícias
    noticias_link = driver.find_element(By.LINK_TEXT, "Notícias")
    noticias_link.click()
    
    # Verificar se as notícias foram carregadas
    if "https://www.google.com/search" in driver.current_url:
        print(f'''\nA pesquisa por noticias "{pesquisa}", funcionou corretamente e as notícias foram carregadas."''')
    else:
        print("\nA pesquisa por notícias NÃO funcionou.")
