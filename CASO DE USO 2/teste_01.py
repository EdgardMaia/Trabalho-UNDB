...
try:
    ...
    # Clicar no link de imagens
    img_link = driver.find_element(By.LINK_TEXT, "Imagens")
    img_link.click()
    time.sleep(3)
    
    # Verificar se as imagens foram carregadas
    if "https://www.google.com/search" in driver.current_url:
        print(f"\nA pesquisa por imagens {pesquisa}, funcionou corretamente e as imagens foram carregadas.")
    else:
        print("\nA pesquisa por imagens NÃO funcionou.")
